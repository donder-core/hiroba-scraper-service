...
func (s *HtmlScraper) ScrapeScoreSummary(genre int, taikoNo string, token string) (string, error) {
	targeturl := fmt.Sprintf("https://donderhiroba.jp/score_list.php?genre=%d&taiko_no=%s", genre, taikoNo)
